...
if __name__ == "__main__":
    ...
    prime_object = Prime()
    print("Result: ", prime_object.is_prime(42))
    prime_object.print_next_prime(42)

#Reference code: https://jeffknupp.com/blog/2013/12/09/improve-your-python-understanding-unit-testing/